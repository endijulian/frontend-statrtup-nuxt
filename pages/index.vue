    ...
    <div class="landing-page">
      ...
      <section class="container mx-auto pt-24">
        ...
        <div class="grid grid-cols-3 gap-4 mt-3">
          <div v-for="campaign in campaigns" :key="campaign.id" class="card-project w-full p-5 border border-gray-500 rounded-20">
            <div class="item">
              ...
              <div class="item-meta">
                ...
                <div class="flex progress-info">
                  ...
                  <div class="ml-auto font-semibold">{{ new Intl.NumberFormat().format(campaign.goal_amount) }}</div>
                </div>
              </div>
              <button
                @click="$router.push(
                ...
                class="text-center mt-3 button-cta block w-full bg-orange-button hover:bg-green-button text-white font-semibold px-6 py-2 text-lg rounded-full"
              >
                Fund Now
              </button>
            </div>
